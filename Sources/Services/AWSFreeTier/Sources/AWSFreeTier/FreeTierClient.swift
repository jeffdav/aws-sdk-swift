...
extension FreeTierClient {
    ...
    public func getFreeTierUsage(input: GetFreeTierUsageInput) async throws -> GetFreeTierUsageOutput {
        ...
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create() as any ClientRuntime.Interceptor<GetFreeTierUsageInput, GetFreeTierUsageOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>)
        }
