...
extension MarketplaceEntitlementClient {
    ...
    public func getEntitlements(input: GetEntitlementsInput) async throws -> GetEntitlementsOutput {
        ...
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create() as any ClientRuntime.Interceptor<GetEntitlementsInput, GetEntitlementsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>)
        }
