...
extension CloudTrailDataClient {
    ...
    public func putAuditEvents(input: PutAuditEventsInput) async throws -> PutAuditEventsOutput {
        ...
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create() as any ClientRuntime.Interceptor<PutAuditEventsInput, PutAuditEventsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>)
        }
